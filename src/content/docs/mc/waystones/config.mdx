...
|add_cooldown(seconds)|Adds the specified amount to the warp cooldown|add_cooldown(60)|
|multiply_cooldown(multiplier)|Multiplies the warp cooldown by the specified amount|multiply_cooldown(2)|
|scaled_add_cooldown(variable, scale)|Adds seconds to the cooldown of the warp in the amount of the specified variable and scale factor|scaled_add_cooldown(distance, 0.01)|
