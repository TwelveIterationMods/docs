...
activated for every other player and is useful for Server Hubs.

Waystones can be broken with a Silk Touch enchanted pickaxe to be able to move them without everyone losing access to
it.
