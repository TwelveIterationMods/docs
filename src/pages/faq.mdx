...
I provide long-term-support (LTS) for bugs and crashes for the earliest least significant patch release of the previous major version.

**The current LTS version is 1.20.1**. That's because it released within a week of 1.20, while 1.20.2 and later only came out a few months after.
