...
Preview builds targetting Minecraft pre-releases or release candidates may be made available to [Patreon](/sponsor) supporters.
...
I provide long-term-support (LTS) for bugs and crashes on certain long-lived versions.

**The current LTS version is 1.20.1 and 1.21.1**.
