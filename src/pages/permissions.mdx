...
- You are maintaining a version that I've chosen to stop supporting, or you want to implement a spin-off feature that I have rejected. Essentially, there should be a tangible reason you're forking the mod that isn't just for the sake of republishing it.
